...
class LivrosControllerTest < ActionController::TestCase
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post :create, livro: { autor: @livro.autor, descricao: @livro.descricao, isbn: @livro.isbn, nome: @livro.nome, publicacao: @livro.publicacao }
    end
  ...
  test "should update livro" do
    patch :update, id: @livro, livro: { autor: @livro.autor, descricao: @livro.descricao, isbn: @livro.isbn, nome: @livro.nome, publicacao: @livro.publicacao }
    assert_redirected_to livro_path(assigns(:livro))
  end
